...
class App:
    ...
    def __init__(self, root=None):
        ...
        # create logo widget
        logo_img = ImageTk.PhotoImage(file="assets/images/food-outline.png")
        ...
        tk.Button(self.frame, text="Let's begin!", font=("Ubuntu", 20), bg="#28393a", fg="white", cursor="hand2", activebackground="#badee2", activeforeground="black", command=self.make_page_1).pack(pady=30)
...
class Page_1:
    def __init__(self, master=None, app=None):
        ...
        # create logo widget
        logo_img = ImageTk.PhotoImage(file="assets/images/pngegg (4).png")
        logo_widget = tk.Label(self.frame, image=logo_img, bg=bg_colour)
        logo_widget.image = logo_img
        logo_widget.pack()
